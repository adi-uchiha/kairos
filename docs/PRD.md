...
- Asks about your _specific_ product context before answering
- Maps recommendations to your _actual_ scale expectations
- Distinguishes between what you need _now_ vs. what you'll need _later_
...
- FR-03: The discovery phase MUST cover at minimum:
  ...
  - Core user workflow (what does a user actually _do_ in this product?)
